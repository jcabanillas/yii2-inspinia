        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-messages">
                <li>
                    <div class="dropdown-messages-box">
                        <a href="profile.html" class="pull-left">
                            <img alt="image" class="img-circle" src="<?= $directoryAsset ?>/img/a7.jpg">
                        </a>
                ...
                <li>
                    <div class="dropdown-messages-box">
                        <a href="profile.html" class="pull-left">
                            <img alt="image" class="img-circle" src="<?= $directoryAsset ?>/img/a4.jpg">
                        </a>
                        <div class="media-body ">
                ...
                <li>
                    <div class="dropdown-messages-box">
                        <a href="profile.html" class="pull-left">
                            <img alt="image" class="img-circle" src="<?= $directoryAsset ?>/img/profile.jpg">
                        </a>
                        <div class="media-body ">
